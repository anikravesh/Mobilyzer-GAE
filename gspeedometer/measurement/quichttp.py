...
"""Contains HTTP-validation logic - for HTTP via Cronet lib and QUIC protocol."""

__author__ = 'nataliya.zozulya@gmail.com (Nataliya Zozulya)'

import logging
from gspeedometer.measurement.measurement_wrapper import MeasurementWrapper

class QUICHTTP(MeasurementWrapper):
    ...
    def Validate(self):
        ...
        try:
            ...
            logging.debug("Missing key for quichttp!")
