...
class Measurement(db.Expando):
  ...
  def JSON_DECODE_values(self, input_dict):
    for k, v in input_dict.items():
      ...
      if k == 'body' or k == 'headers' or k == 'error' or k == 'context_results' or ('navigationTimingResults' in k) or ('resource_' in k) or k == 'tcp_speed_results' or k.startswith("video_"):
